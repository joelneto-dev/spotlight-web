...
export default function LoginPage() {
  return (
    <div className="bg-sp-base relative flex min-h-screen items-center justify-center overflow-hidden pb-24 pt-32">
      ...
      <Section className="relative z-10 flex items-center justify-center px-4">
        <GlassCard className="w-full max-w-md p-8 text-center sm:p-10">
          <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full border border-white/10 bg-black/60">
          ...
          <div className="mt-7 flex items-start gap-3 rounded-lg border border-white/10 bg-white/[0.04] p-4 text-left">
            ...
            <p className="text-xs leading-6 text-neutral-400">
              <strong className="block font-semibold text-white">Versão 1.0</strong>
              O painel web nativo está planejado para a próxima etapa. Por enquanto, o acesso leva
              para a plataforma do app.
            </p>
          </div>

          <Button href={SITE_CONFIG.appUrl} external variant="primary" className="group mt-7 w-full">
            Ir para o aplicativo
            <ArrowRight className="ml-2 h-4 w-4 transition-transform group-hover:translate-x-1" />
          </Button>

          <p className="mt-5 font-mono text-[10px] uppercase tracking-[0.16em] text-neutral-600">
